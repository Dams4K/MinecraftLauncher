...
func _enter_tree() -> void:
	...
	add_custom_type("MCInstallation", "Node", preload("res://addons/minecraft_launcher/version_components/mc_installation.gd"), preload("res://addons/minecraft_launcher/icon.svg"))
